...
int main(int argc, char* argv []){
    ...
    g_peer_impl = std::make_shared<peer>(id,"127.0.0.1",pss_port,data_port,pos,2,view_size,sleep_interval,gossip_size, logging_interval, anti_entropy_interval, logging_dir,
