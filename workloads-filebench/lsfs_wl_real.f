...
define process name="process1", instances=1
{
    thread name="thread1", memsize=4k, instances=1
    {
        ...
        flowop write name="write1", fd=1, iosize=4k, iters=$nwrites
    ...
    thread name="thread2", memsize=4k, instances=1
    {
        ...
        flowop write name="write2", fd=1, iosize=4k, iters=$nwrites
    ...
    thread name="thread3", memsize=4k, instances=1
    {
        ...
        flowop write name="write3", fd=1, iosize=4k, iters=$nwrites
    ...
    thread name="thread4", memsize=4k, instances=1
    {
        ...
        flowop write name="write4", fd=1, iosize=4k, iters=$nwrites
