...
template<class T> fuse_wrapper::t_lookup fuse_wrapper::fuse<T>::lookup = nullptr;
template<class T> fuse_wrapper::t_forget fuse_wrapper::fuse<T>::forget = nullptr;
template<class T> fuse_wrapper::t_getattr fuse_wrapper::fuse<T>::getattr = nullptr;
template<class T> fuse_wrapper::t_setattr fuse_wrapper::fuse<T>::setattr = nullptr;
...
template<class T> fuse_wrapper::t_getlk fuse_wrapper::fuse<T>::getlk = nullptr;
template<class T> fuse_wrapper::t_setlk fuse_wrapper::fuse<T>::setlk = nullptr;
...
template<class T> fuse_wrapper::t_retrieve_reply fuse_wrapper::fuse<T>::retrieve_reply = nullptr;
template<class T> fuse_wrapper::t_forget_multi fuse_wrapper::fuse<T>::forget_multi = nullptr;
...
template<class T> struct fuse_lowlevel_ops fuse_wrapper::fuse<T>::operations_;