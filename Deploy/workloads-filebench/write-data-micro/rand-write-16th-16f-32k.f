...
# 16 threads in a single process randomly write 32 KiB blocks to separate
...
define process name="process1", instances=1
{
    thread name="thread1", memsize=32k, instances=1
    {
        ...
        flowop write name="write1", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread2", memsize=32k, instances=1
    {
        ...
        flowop write name="write2", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread3", memsize=32k, instances=1
    {
        ...
        flowop write name="write3", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread4", memsize=32k, instances=1
    {
        ...
        flowop write name="write4", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread5", memsize=32k, instances=1
    {
        ...
        flowop write name="write5", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread6", memsize=32k, instances=1
    {
        ...
        flowop write name="write6", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread7", memsize=32k, instances=1
    {
        ...
        flowop write name="write7", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread8", memsize=32k, instances=1
    {
        ...
        flowop write name="write8", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread9", memsize=32k, instances=1
    {
        ...
        flowop write name="write9", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread10", memsize=32k, instances=1
    {
        ...
        flowop write name="write10", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread11", memsize=32k, instances=1
    {
        ...
        flowop write name="write11", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread12", memsize=32k, instances=1
    {
        ...
        flowop write name="write12", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread13", memsize=32k, instances=1
    {
        ...
        flowop write name="write13", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread14", memsize=32k, instances=1
    {
        ...
        flowop write name="write14", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread15", memsize=32k, instances=1
    {
        ...
        flowop write name="write15", fd=1, iosize=32k, iters=131072, random
    ...
    thread name="thread16", memsize=32k, instances=1
    {
        ...
        flowop write name="write16", fd=1, iosize=32k, iters=131072, random
