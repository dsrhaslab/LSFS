...
define fileset name="fileset1", path="/home/danielsf97/lsfs-mount/mount", entries=1, dirwidth=1, dirgamma=0, filesize=6000000k  #6000000k
...
define process name="process1", instances=1
{
    thread name="thread1", memsize=1m, instances=1
    {
        ...
        flowop write name="write1", fd=1, iosize=1m, iters=1500000  #1500000
