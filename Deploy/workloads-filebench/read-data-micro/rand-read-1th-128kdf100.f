...
define fileset name="fileset1", path="/home/danielsf97/lsfs-mount/mount", entries=1, dirwidth=1, dirgamma=0, prealloc, filesize=2500000k, reuse
...
define process name="process1", instances=1
{
    thread name="thread1", memsize=128k, instances=1
    {
        ...
        flowop read name="read1", fd=1, iosize=128k, iters=524288, random
