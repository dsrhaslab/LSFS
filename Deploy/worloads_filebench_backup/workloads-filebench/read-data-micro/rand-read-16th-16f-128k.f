...
# 16 threads in a single process randomly read 128 KiB blocks from separate
# preallocated 4 GiB files until one of the threads has read 4 GiB.

# ---------------------------------------------------------------------------- #

define fileset name="fileset1", path="/home/danielsf97/lsfs-mount/mount", entries=16, dirwidth=16, dirgamma=0, prealloc, filesize=64000000k, reuse
