...
define process name="process1", instances=1
{
    thread name="thread1", memsize=1m, instances=1
    {
        ...
        flowop read name="read1", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread2", memsize=1m, instances=1
    {
        ...
        flowop read name="read2", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread3", memsize=1m, instances=1
    {
        ...
        flowop read name="read3", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread4", memsize=1m, instances=1
    {
        ...
        flowop read name="read4", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread5", memsize=1m, instances=1
    {
        ...
        flowop read name="read5", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread6", memsize=1m, instances=1
    {
        ...
        flowop read name="read6", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread7", memsize=1m, instances=1
    {
        ...
        flowop read name="read7", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread8", memsize=1m, instances=1
    {
        ...
        flowop read name="read8", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread9", memsize=1m, instances=1
    {
        ...
        flowop read name="read9", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread10", memsize=1m, instances=1
    {
        ...
        flowop read name="read10", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread11", memsize=1m, instances=1
    {
        ...
        flowop read name="read11", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread12", memsize=1m, instances=1
    {
        ...
        flowop read name="read12", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread13", memsize=1m, instances=1
    {
        ...
        flowop read name="read13", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread14", memsize=1m, instances=1
    {
        ...
        flowop read name="read14", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread15", memsize=1m, instances=1
    {
        ...
        flowop read name="read15", fd=1, iosize=1m, iters=4096, random
    ...
    thread name="thread16", memsize=1m, instances=1
    {
        ...
        flowop read name="read16", fd=1, iosize=1m, iters=4096, random
