...
# 16 threads in a single process delete a total of at most 4 million
# preallocated 4 KiB files.
...
set $dir_width=1000
set $num_iters_per_thread=250000
...
define process name="process1", instances=1
{
    ...
    {
        flowop deletefile name="delete1", filesetname="fileset1", iters=$num_iters_per_thread
