...
define fileset name="fileset1", path="/home/danielsf97/lsfs-mount/mount", entries=1, dirwidth=1, dirgamma=0, filesize=640000000k
...
define process name="process1", instances=1
{
    thread name="thread1", memsize=4k, instances=1
    {
        ...
        flowop write name="write1", fd=1, iosize=4k, iters=160000000
