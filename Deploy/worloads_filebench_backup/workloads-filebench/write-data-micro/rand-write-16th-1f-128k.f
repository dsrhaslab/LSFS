...
# 16 threads in a single process randomly write 128 KiB blocks to the same
# preallocated 64 GiB file until one of the threads has written 64 GiB.
...
define process name="process1", instances=1
{
    thread name="thread1", memsize=128k, instances=16
    {
        ...
        flowop write name="write1", fd=1, iosize=128k, iters=524288, random
