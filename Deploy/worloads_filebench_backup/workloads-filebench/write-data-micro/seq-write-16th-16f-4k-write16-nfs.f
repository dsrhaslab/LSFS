...
define fileset name="fileset1", path="/home/danielsf97/lsfs-mount/mount", entries=16, dirwidth=16, dirgamma=0, filesize=20000000k
...
define process name="process1", instances=1
{
    thread name="thread1", memsize=1m, instances=1
    {
        ...
        flowop write name="write1", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread2", memsize=1m, instances=1
    {
        ...
        flowop write name="write2", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread3", memsize=1m, instances=1
    {
        ...
        flowop write name="write3", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread4", memsize=1m, instances=1
    {
        ...
        flowop write name="write4", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread5", memsize=1m, instances=1
    {
        ...
        flowop write name="write5", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread6", memsize=1m, instances=1
    {
        ...
        flowop write name="write6", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread7", memsize=1m, instances=1
    {
        ...
        flowop write name="write7", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread8", memsize=1m, instances=1
    {
        ...
        flowop write name="write8", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread9", memsize=1m, instances=1
    {
        ...
        flowop write name="write9", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread10", memsize=1m, instances=1
    {
        ...
        flowop write name="write10", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread11", memsize=1m, instances=1
    {
        ...
        flowop write name="write11", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread12", memsize=1m, instances=1
    {
        ...
        flowop write name="write12", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread13", memsize=1m, instances=1
    {
        ...
        flowop write name="write13", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread14", memsize=1m, instances=1
    {
        ...
        flowop write name="write14", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread15", memsize=1m, instances=1
    {
        ...
        flowop write name="write15", fd=1, iosize=1m, iters=5000000
    ...
    thread name="thread16", memsize=1m, instances=1
    {
        ...
        flowop write name="write16", fd=1, iosize=1m, iters=5000000
